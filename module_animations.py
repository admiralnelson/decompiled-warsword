...
animations = [
  ["stand", 0, amf_client_prediction,
    ...
    [3, "anim_human", 60, 62, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
  ...
  ["release_thrust_twohanded", acf_anim_length(100)|acf_thrust|acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
    [0.61, "anim_human", 26010, 26031, arf_blend_in_5],
  ],
  ...
  ["release_thrust_onehanded", acf_anim_length(100)|acf_enforce_rightside|acf_thrust|acf_rot_vertical_sword, amf_priority_attack|amf_rider_rot_thrust|amf_use_weapon_speed|amf_play|amf_continue_to_next,
    [0.62, "attacks_thrust_onehanded", 12, 32, arf_blend_in_5],
  ],
  ...
  ["release_thrust_onehanded_lance", acf_anim_length(100)|acf_enforce_rightside|acf_thrust|acf_rot_vertical_sword, amf_priority_attack|amf_rider_rot_thrust|amf_use_weapon_speed|amf_play|amf_continue_to_next,
    [0.62, "thrust_onehanded_lance_hb", 8, 33, arf_blend_in_5],
  ],
  ...
  ["release_thrust_staff", acf_anim_length(100)|acf_thrust|acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_play,
    [0.6, "attacks_staff_thrust", 21, 40, arf_blend_in_5],
  ],
  ...
  ["ready_overswing_spear", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_use_inertia,
    [0.35, "spear_thrust_overhead", 0, 20, arf_blend_in_6],
  ],
  ["release_overswing_spear", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
    [0.6, "spear_thrust_overhead", 20, 41, arf_blend_in_5],
  ],
  ...
  ["ready_overswing_musket", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_use_inertia,
    [0.35, "musket_upper_swing", 12, 24, arf_blend_in_6],
  ],
  ["release_overswing_musket", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
    [0.55, "musket_upper_swing", 24, 40, arf_blend_in_5],
  ],
  ...
  ["parried_overswing_musket", 0, amf_priority_defend_parry|amf_use_weapon_speed|amf_play,
    [0.6, "musket_upper_swing", 34, 30, arf_blend_in_5],
  ],
  ["blocked_overswing_musket", 0, amf_priority_defend_parry|amf_use_weapon_speed|amf_play,
    [0.3, "musket_upper_swing", 34, 30, arf_blend_in_5],
  ],
  ...
  ["spearwall_bracing", acf_align_with_ground|acf_enforce_all|acf_thrust, amf_priority_kick|amf_keep,
    [2.5, "pike_brace", 0, 190, arf_blend_in_1],
  ],
  ["spearwall_bracing_low", acf_align_with_ground|acf_enforce_all|acf_thrust, amf_priority_kick|amf_keep,
    [3, "pike_brace", 329, 535, arf_blend_in_1],
  ],
  ...
  ["spearwall_bracing_recoil", acf_anim_length(100)|acf_rot_vertical_bow, amf_priority_kick|amf_use_weapon_speed|amf_play,
    [0.7, "anim_human", 27316, 27313, arf_blend_in_2],
  ],
  ["shield_bash", acf_enforce_all, amf_priority_striked|amf_use_defend_speed|amf_play|amf_client_owner_prediction,
    [0.75, "shield_bash", 0, 30, arf_blend_in_3],
  ],
  ["magic", acf_enforce_all, amf_priority_striked|amf_accurate_body|amf_play|amf_restart,
    [5, "ani_magic_1", 0, 43, arf_blend_in_3],
  ],
  ["shield_strike", acf_align_with_ground|acf_enforce_all, amf_priority_striked|amf_accurate_body|amf_play|amf_restart,
    [2, "anim_human", 45000, 45010, arf_blend_in_3|arf_make_custom_sound],
    [2.5, "anim_human", 45400, 45453, arf_blend_in_2|arf_make_custom_sound],
    [2.5, "anim_human", 45400, 45445, arf_blend_in_2|arf_make_custom_sound],
  ],
  ...
  ["mount_leap_attack", acf_align_with_ground|acf_enforce_all|acf_displace_position, amf_priority_rear|amf_play,
    [1, "wargLeapAttack", 0, 20, arf_blend_in_4|arf_use_walk_progress, pack4f(0.66, 0.65, 0.16, 0.15), (0, 0, 0), 0.9],
  ],
  ["mount_attack", acf_align_with_ground|acf_enforce_all|acf_displace_position, amf_priority_rear|amf_play,
    [1, "wolf_snap", 0, 54, arf_blend_in_4|arf_use_walk_progress, pack4f(0.66, 0.65, 0.16, 0.15), (0, 0, 0), 0.9],
  ],
